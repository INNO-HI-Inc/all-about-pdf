...
${s.body}`).join('\n');
  ...
  const main = `<section class="gd-hero">
      <div class="gd-wrap">
        ...
        <span class="gd-eyebrow">PDF 가이드</span>
        <h1 class="gd-title">${esc(g.title)}</h1>
        <p class="gd-sub">${esc(g.desc)}</p>
        <p class="gd-meta"><span>읽는 시간 약 ${readMin}분</span><span class="gd-dot" aria-hidden="true">·</span><time datetime="${fileDate(g._src)}">${fileDate(g._src)} 업데이트</time></p>
      </div>
    </section>
